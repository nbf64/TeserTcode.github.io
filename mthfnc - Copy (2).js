...
function sq(x){return div(1,add(1,cot(x)))}
function cq(x){return div(1,add(1,tan(x)))}
function aq(x){return add(div(sub(sec(sub(x,div(pi(),4))),1),2),div(sqrt(2),2))}
...
function tav(x){return div(sin(x),mag(cos(x)))}
...
function sinphi(x,phi){return rsignumapply(sqrt(add(sqr(sin(x)),sqr(div(sin(x),tan(phi))))));}
...
function arcaex(x,s,e=0){return add(asin(div(sin(x),s)),e)}
...
function nome(k){return exp(mul(-1,pi(),div(compellint1(sqrt(sub(1,mul(k,k)))),compellint1(k))))}
function arcnome(q){
	//let q = modulartransformqt(qq);
//return div(mul(16,pow(dedekindeta(mul(0.5,t)),8),pow(dedekindeta(mul(2,t)),16)),pow(dedekindeta(t),24))}	
return pow(div(jacobitheta2(0,q),jacobitheta3(0,q)),4)}
...
function modulartransformqk(q){return pow(div(jacobitheta2(0,q),jacobitheta3(0,q)),2)};
